...
<head>
	...
	<!-- Execute Cloudsuo plugins for the hook "Site head" -->
	<?php Theme::plugins('siteHead'); ?>
</head>

<body>

	<!-- Execute Cloudsuo plugins for the hook "Site body begin" -->
	...
	<!-- Execute Cloudsuo plugins for the hook "Site body end" -->
